...
public class XmlContentMatcher implements FileMatcher {
    private String pattern;

    public XmlContentMatcher(String propertyName, String propertyValue) {
        this.pattern = propertyName + "=\"" + propertyValue + "\"";
    }
